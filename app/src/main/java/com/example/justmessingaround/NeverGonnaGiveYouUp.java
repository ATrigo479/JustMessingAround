...
public class NeverGonnaGiveYouUp extends AppCompatActivity {

    //Indian dude was a big help, as all his code
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_never_gonna_give_you_up);
